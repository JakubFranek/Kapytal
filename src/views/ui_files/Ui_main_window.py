...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuRecent_Files = QtWidgets.QMenu(parent=self.menuFile)
        self.menuRecent_Files.setObjectName("menuRecent_Files")
        self.menuDemos_and_Templates = QtWidgets.QMenu(parent=self.menuFile)
        self.menuDemos_and_Templates.setObjectName("menuDemos_and_Templates")
        self.menuForms = QtWidgets.QMenu(parent=self.menubar)
        self.menuForms.setObjectName("menuForms")
        self.menuReports = QtWidgets.QMenu(parent=self.menubar)
        self.menuReports.setObjectName("menuReports")
        self.menuCash_Flow = QtWidgets.QMenu(parent=self.menuReports)
        self.menuCash_Flow.setObjectName("menuCash_Flow")
        self.menuNet_Worth = QtWidgets.QMenu(parent=self.menuReports)
        self.menuNet_Worth.setObjectName("menuNet_Worth")
        self.menuCategories = QtWidgets.QMenu(parent=self.menuReports)
        self.menuCategories.setObjectName("menuCategories")
        self.menuTags = QtWidgets.QMenu(parent=self.menuReports)
        self.menuTags.setObjectName("menuTags")
        self.menuPayees = QtWidgets.QMenu(parent=self.menuReports)
        ...
        self.actionCurrencies = QtGui.QAction(parent=MainWindow)
        self.actionCurrencies.setObjectName("actionCurrencies")
        self.actionQuit = QtGui.QAction(parent=MainWindow)
        self.actionQuit.setObjectName("actionQuit")
        self.actionAbout = QtGui.QAction(parent=MainWindow)
        self.actionAbout.setObjectName("actionAbout")
        self.actionSecurities = QtGui.QAction(parent=MainWindow)
        self.actionSecurities.setObjectName("actionSecurities")
        self.actionPayees = QtGui.QAction(parent=MainWindow)
        ...
        self.actionTags = QtGui.QAction(parent=MainWindow)
        ...
        self.actionOpen_Kapytal_GitHub_page = QtGui.QAction(parent=MainWindow)
        self.actionOpen_Kapytal_GitHub_page.setObjectName("actionOpen_Kapytal_GitHub_page")
        self.actionBasicDemo = QtGui.QAction(parent=MainWindow)
        self.actionBasicDemo.setObjectName("actionBasicDemo")
        self.actionMortgage_Demo = QtGui.QAction(parent=MainWindow)
        self.actionMortgage_Demo.setObjectName("actionMortgage_Demo")
        self.actionCategory_Template_EN = QtGui.QAction(parent=MainWindow)
        self.actionCategory_Template_EN.setObjectName("actionCategory_Template_EN")
        self.actionCategory_Template_CZ = QtGui.QAction(parent=MainWindow)
        self.actionCategory_Template_CZ.setObjectName("actionCategory_Template_CZ")
        self.actionImport_Transactions = QtGui.QAction(parent=MainWindow)
        self.actionImport_Transactions.setObjectName("actionImport_Transactions")
        self.menuRecent_Files.addSeparator()
        self.menuRecent_Files.addAction(self.actionClear_Recent_File_Menu)
        self.menuDemos_and_Templates.addAction(self.actionBasicDemo)
        self.menuDemos_and_Templates.addAction(self.actionMortgage_Demo)
        self.menuDemos_and_Templates.addSeparator()
        self.menuDemos_and_Templates.addAction(self.actionCategory_Template_EN)
        self.menuDemos_and_Templates.addAction(self.actionCategory_Template_CZ)
        self.menuFile.addAction(self.actionNew_File)
        self.menuFile.addAction(self.actionOpen_File)
        self.menuFile.addAction(self.menuRecent_Files.menuAction())
        self.menuFile.addAction(self.menuDemos_and_Templates.menuAction())
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionImport_Transactions)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionSave)
        self.menuFile.addAction(self.actionSave_As)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionQuit)
        self.menuForms.addAction(self.actionCurrencies)
        self.menuForms.addAction(self.actionSecurities)
        self.menuForms.addSeparator()
        self.menuForms.addAction(self.actionCategories)
        self.menuForms.addAction(self.actionTags)
        self.menuForms.addAction(self.actionPayees)
        self.menuForms.addSeparator()
        self.menuForms.addAction(self.actionUpdate_Quotes)
        self.menuForms.addSeparator()
        self.menuForms.addAction(self.actionSettings)
        ...
        self.toolBar.addAction(self.actionCurrencies)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuDemos_and_Templates.setTitle(_translate("MainWindow", "Demos and Templates"))
        ...
        self.actionCurrencies.setText(_translate("MainWindow", "Currencies"))
        self.actionCurrencies.setToolTip(_translate("MainWindow", "Currencies"))
        ...
        self.actionOpen_Kapytal_GitHub_page.setText(_translate("MainWindow", "Open Kapytal on GitHub"))
        self.actionBasicDemo.setText(_translate("MainWindow", "Basic Demo"))
        self.actionMortgage_Demo.setText(_translate("MainWindow", "Mortgage Demo"))
        self.actionCategory_Template_EN.setText(_translate("MainWindow", "Category Template (EN)"))
        self.actionCategory_Template_CZ.setText(_translate("MainWindow", "Category Template (CZ)"))
        self.actionImport_Transactions.setText(_translate("MainWindow", "Import Transactions"))
