...
class Ui_CategoryReport(object):
    def setupUi(self, CategoryReport):
        ...
        self.showTransactionsToolButton = QtWidgets.QToolButton(self.layoutWidget)
        ...
        self.recalculateReportToolButton = QtWidgets.QToolButton(self.layoutWidget)
        ...
        self.chartVerticalLayout.addLayout(self.controlsHorizontalLayout)
