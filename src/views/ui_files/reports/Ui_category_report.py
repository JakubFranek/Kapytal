...
class Ui_CategoryReport(object):
    def setupUi(self, CategoryReport):
        ...
        self.expandAllToolButton = QtWidgets.QToolButton(self.widget)
        ...
        self.collapseAllToolButton = QtWidgets.QToolButton(self.widget)
        ...
        self.currencyNoteLabel = QtWidgets.QLabel(self.widget)
