...
class Ui_CashFlowOverallReport(object):
    def setupUi(self, CashFlowOverallReport):
        ...
        CashFlowOverallReport.resize(800, 600)
        ...
        self.netGrowthLabel = QtWidgets.QLabel(CashFlowOverallReport)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.netGrowthAmountLabel = QtWidgets.QLabel(CashFlowOverallReport)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.line = QtWidgets.QFrame(CashFlowOverallReport)
    ...
    def retranslateUi(self, CashFlowOverallReport):
        ...
        self.netGrowthLabel.setText(_translate("CashFlowOverallReport", "Net Growth"))
        self.netGrowthAmountLabel.setText(_translate("CashFlowOverallReport", "TextLabel"))
