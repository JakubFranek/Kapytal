...
class Ui_TagForm(object):
    def setupUi(self, TagForm):
        ...
        self.showTransactionsToolButton = QtWidgets.QToolButton(TagForm)
        ...
        self.actionShow_Transactions = QtGui.QAction(TagForm)
    ...
    def retranslateUi(self, TagForm):
        ...
        self.showTransactionsToolButton.setText(_translate("TagForm", "..."))
        ...
        self.actionShow_Transactions.setText(_translate("TagForm", "Show Transactions"))
