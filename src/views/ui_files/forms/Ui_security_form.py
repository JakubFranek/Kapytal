...
class Ui_SecurityForm(object):
    def setupUi(self, SecurityForm):
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=SecurityForm)
        ...
        self.splitter = QtWidgets.QSplitter(parent=self.manageSecuritiesTab)
        ...
        self.updateQuotesToolButton = QtWidgets.QToolButton(parent=self.verticalLayoutWidget)
        ...
        self.manageSearchLineEdit = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget)
        ...
        self.securityTableView = QtWidgets.QTableView(parent=self.verticalLayoutWidget)
        ...
        self.addPriceToolButton = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        self.editPriceToolButton = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        self.removePriceToolButton = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        self.loadPriceDataToolButton = QtWidgets.QToolButton(parent=self.layoutWidget)
        ...
        self.securityPriceTableView = QtWidgets.QTableView(parent=self.layoutWidget)
        ...
        self.expandAllToolButton = QtWidgets.QToolButton(parent=self.securitiesOverviewTab)
        ...
        self.collapseAllToolButton = QtWidgets.QToolButton(parent=self.securitiesOverviewTab)
        ...
        self.securitiesOverviewControlsLine_1 = QtWidgets.QFrame(parent=self.securitiesOverviewTab)
        ...
        self.statsTypeLabel = QtWidgets.QLabel(parent=self.securitiesOverviewTab)
        self.statsTypeLabel.setObjectName("statsTypeLabel")
        self.overviewControlsHorizontalLayout.addWidget(self.statsTypeLabel)
        self.statsTypeComboBox = QtWidgets.QComboBox(parent=self.securitiesOverviewTab)
        ...
        self.securitiesOverviewControlsLine_2 = QtWidgets.QFrame(parent=self.securitiesOverviewTab)
        ...
        self.nativeCurrencyStatsCheckBox = QtWidgets.QCheckBox(parent=self.securitiesOverviewTab)
        ...
        self.securitiesOverviewControlsLine_3 = QtWidgets.QFrame(parent=self.securitiesOverviewTab)
        ...
        self.detailedStatsCheckBox = QtWidgets.QCheckBox(parent=self.securitiesOverviewTab)
        ...
        self.overviewSearchLineEdit = QtWidgets.QLineEdit(parent=self.securitiesOverviewTab)
        self.overviewSearchLineEdit.setClearButtonEnabled(True)
        ...
        self.treeView = QtWidgets.QTreeView(parent=self.securitiesOverviewTab)
        ...
        self.actionAdd_Security = QtGui.QAction(parent=SecurityForm)
        self.actionAdd_Security.setObjectName("actionAdd_Security")
        self.actionEdit_Security = QtGui.QAction(parent=SecurityForm)
        self.actionEdit_Security.setObjectName("actionEdit_Security")
        self.actionRemove_Security = QtGui.QAction(parent=SecurityForm)
        self.actionRemove_Security.setObjectName("actionRemove_Security")
        self.actionExpand_All = QtGui.QAction(parent=SecurityForm)
        self.actionExpand_All.setObjectName("actionExpand_All")
        self.actionCollapse_All = QtGui.QAction(parent=SecurityForm)
        self.actionCollapse_All.setObjectName("actionCollapse_All")
        self.actionAdd_Price = QtGui.QAction(parent=SecurityForm)
        self.actionAdd_Price.setObjectName("actionAdd_Price")
        self.actionEdit_Price = QtGui.QAction(parent=SecurityForm)
        self.actionEdit_Price.setObjectName("actionEdit_Price")
        self.actionRemove_Price = QtGui.QAction(parent=SecurityForm)
        self.actionRemove_Price.setObjectName("actionRemove_Price")
        self.actionLoad_Price_Data = QtGui.QAction(parent=SecurityForm)
        self.actionLoad_Price_Data.setObjectName("actionLoad_Price_Data")
        self.actionUpdate_Quotes = QtGui.QAction(parent=SecurityForm)
