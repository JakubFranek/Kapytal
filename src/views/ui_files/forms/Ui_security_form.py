...
class Ui_SecurityForm(object):
    def setupUi(self, SecurityForm):
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.manageSecuritiesTab)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.manageControlsHorizontalLayout = QtWidgets.QHBoxLayout()
        self.manageControlsHorizontalLayout.setObjectName("manageControlsHorizontalLayout")
        self.addToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        self.addToolButton.setObjectName("addToolButton")
        self.manageControlsHorizontalLayout.addWidget(self.addToolButton)
        self.editToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        self.editToolButton.setObjectName("editToolButton")
        self.manageControlsHorizontalLayout.addWidget(self.editToolButton)
        self.removeToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        self.removeToolButton.setObjectName("removeToolButton")
        self.manageControlsHorizontalLayout.addWidget(self.removeToolButton)
        self.manageSearchLineEdit = QtWidgets.QLineEdit(self.manageSecuritiesTab)
        self.manageSearchLineEdit.setClearButtonEnabled(True)
        self.manageSearchLineEdit.setObjectName("manageSearchLineEdit")
        self.manageControlsHorizontalLayout.addWidget(self.manageSearchLineEdit)
        self.verticalLayout_3.addLayout(self.manageControlsHorizontalLayout)
        self.securityTableView = QtWidgets.QTableView(self.manageSecuritiesTab)
        ...
        self.verticalLayout_3.addWidget(self.securityTableView)
        self.horizontalLine = QtWidgets.QFrame(self.manageSecuritiesTab)
        ...
        self.verticalLayout_3.addWidget(self.horizontalLine)
        self.securityPriceHorizontalLayout = QtWidgets.QHBoxLayout()
        ...
        self.addPriceToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        ...
        self.editPriceToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        ...
        self.removePriceToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        ...
        self.loadPriceDataToolButton = QtWidgets.QToolButton(self.manageSecuritiesTab)
        ...
        self.securityPriceTableView = QtWidgets.QTableView(self.manageSecuritiesTab)
        ...
        self.line = QtWidgets.QFrame(self.manageSecuritiesTab)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.securityPriceHorizontalLayout.addWidget(self.line)
        self.verticalLayout_3.addLayout(self.securityPriceHorizontalLayout)
