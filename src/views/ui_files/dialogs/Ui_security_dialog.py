...
class Ui_SecurityDialog(object):
    ...
    def retranslateUi(self, SecurityDialog):
        ...
        self.decimalsLabel.setToolTip(_translate("SecurityDialog", "<html><head/><body><p>Number of decimals of Security shares.</p><p><br/>For example:</p><p>0 decimals - shares are multiples of 1</p><p>1 decimals - shares are multiples of 0.1</p></body></html>"))
