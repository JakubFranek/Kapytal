...
class Ui_RefundTransactionDialog(object):
    def setupUi(self, RefundTransactionDialog):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.accountsComboBox)
        ...
        RefundTransactionDialog.setTabOrder(self.accountsComboBox, self.payeeComboBox)
