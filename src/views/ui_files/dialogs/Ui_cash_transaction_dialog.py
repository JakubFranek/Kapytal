...
class Ui_CashTransactionDialog(object):
    def setupUi(self, CashTransactionDialog):
        ...
        self.tagsPlainTextEdit = QtWidgets.QPlainTextEdit(CashTransactionDialog)
        self.tagsPlainTextEdit.setObjectName("tagsPlainTextEdit")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.tagsPlainTextEdit)
