...
class Ui_CashTransactionDialog(object):
    def setupUi(self, CashTransactionDialog):
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.categoryComboBox)
        ...
        CashTransactionDialog.setTabOrder(self.payeeLineEdit, self.descriptionPlainTextEdit)
        CashTransactionDialog.setTabOrder(self.descriptionPlainTextEdit, self.amountDoubleSpinBox)
        CashTransactionDialog.setTabOrder(self.amountDoubleSpinBox, self.tagsLineEdit)
