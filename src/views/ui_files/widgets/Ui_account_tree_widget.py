...
class Ui_AccountTreeWidget(object):
    def setupUi(self, AccountTreeWidget):
        ...
        self.treeView.header().setMinimumSectionSize(10)
        self.treeView.header().setSortIndicatorShown(True)
        self.treeView.header().setStretchLastSection(False)
        self.verticalLayout.addWidget(self.treeView)
        self.checkedAccountBalanceFormLayout = QtWidgets.QFormLayout()
        self.checkedAccountBalanceFormLayout.setObjectName("checkedAccountBalanceFormLayout")
        self.checkedAccountBalanceLabel = QtWidgets.QLabel(AccountTreeWidget)
        self.checkedAccountBalanceLabel.setObjectName("checkedAccountBalanceLabel")
        self.checkedAccountBalanceFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.checkedAccountBalanceLabel)
        self.checkedAccountBalanceAmountLabel = QtWidgets.QLabel(AccountTreeWidget)
        self.checkedAccountBalanceAmountLabel.setText("")
        self.checkedAccountBalanceAmountLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.checkedAccountBalanceAmountLabel.setObjectName("checkedAccountBalanceAmountLabel")
        self.checkedAccountBalanceFormLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.checkedAccountBalanceAmountLabel)
        self.verticalLayout.addLayout(self.checkedAccountBalanceFormLayout)
