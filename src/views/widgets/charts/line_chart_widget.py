...
class LineChartWidget(QWidget):
    def __init__(self, parent: QWidget | None) -> None:
        ...
        self.lines = None
        self.chart_toolbar = NavigationToolbar2QT(
            self.chart, None
        )  # TODO: possibly not needed because its already in toolbar actions init method
    ...
    # TODO: refactor toolbar into separate base class
