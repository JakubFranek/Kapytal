...
class SecuritiesOverviewTreeColumn(IntEnum):
    ...
    GAIN_TOTAL_NATIVE = 19
    GAIN_TOTAL_BASE = 20
    GAIN_TOTAL_CURRENCY_BASE = 21
    RETURN_TOTAL_NATIVE = 22
    RETURN_TOTAL_BASE = 23
    IRR_TOTAL_NATIVE = 24
    IRR_TOTAL_BASE = 25

    GAIN_REALIZED_NATIVE = 26
    GAIN_REALIZED_BASE = 27
    GAIN_DIVIDEND_NATIVE = 28
    GAIN_DIVIDEND_BASE = 29
    RETURN_REALIZED_NATIVE = 30
    RETURN_REALIZED_BASE = 31

    GAIN_UNREALIZED_NATIVE = 32
    GAIN_UNREALIZED_BASE = 33
    RETURN_UNREALIZED_NATIVE = 34
    RETURN_UNREALIZED_BASE = 35
