...
@given(code=strategies.text(alphabet=string.ascii_letters, min_size=3, max_size=3))
...
@given(code=strategies.text(max_size=2))
...
@given(code=strategies.text(min_size=4))
...
@given(code=strategies.text(min_size=3, max_size=3))
